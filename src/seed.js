...
const users = [
  {
    ...
    address: { line_1: "123 Main Street", line_2: "Apt 4B", city: "New York", state: "NY", country: "USA", zip: "10001" },
  },
  {
    fname: "Jane",
    lname: "Smith",
    email: "jane.smith@example.com",
    address: { line_1: "456 Oak Avenue", line_2: "", city: "Los Angeles", state: "CA", country: "USA", zip: "90210" },
  },
  {
    fname: "Michael",
    lname: "Johnson",
    email: "michael.johnson@example.com",
    address: { line_1: "789 Pine Road", line_2: "Suite 12", city: "Chicago", state: "IL", country: "USA", zip: "60601" },
  },
  {
    fname: "Sarah",
    lname: "Williams",
    email: "sarah.williams@example.com",
    address: { line_1: "321 Elm Street", line_2: "", city: "Boston", state: "MA", country: "USA", zip: "02101" },
  },
];
...
// Sample reviews data
const reviews = [
  { rating: 5, comment: "Absolutely amazing hotel! The views are breathtaking and the service is impeccable." },
  { rating: 4, comment: "Great location and comfortable rooms. Would definitely recommend!" },
  { rating: 5, comment: "Perfect stay! The amenities are top-notch and the staff is very friendly." },
  { rating: 4, comment: "Beautiful hotel with excellent facilities. The breakfast was delicious." },
  { rating: 5, comment: "Outstanding experience! The room was spacious and the view was spectacular." },
  { rating: 4, comment: "Very nice hotel with good service. The location is convenient." },
  { rating: 5, comment: "Exceptional hotel! Everything exceeded our expectations." },
  { rating: 4, comment: "Lovely stay! The hotel is clean and the staff is helpful." },
];

// Sample locations data (extracted from hotel locations)
const locations = [{ name: "France" }, { name: "Australia" }, { name: "Japan" }];
